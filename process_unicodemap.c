 ...
 *
 * NOTE: This change is added after having issues using XP command to keep two different unicodes on one key. 
 * Something (i'm not smart enough to understand) made it print lower letter (without shift) before printing upper letter. 
 *
